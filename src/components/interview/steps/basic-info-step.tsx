...
import { basicInfoSchema, type BasicInfoFormData } from '@/lib/validations/interview'
...
export function BasicInfoStep({ initialData, onComplete, onCancel }: BasicInfoStepProps) {
  const {
    register,
    handleSubmit,
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Please provide your contact information and basic details about your child
        </CardDescription>
      </CardHeader>
      <CardContent>
